    ...
    >
      <div class="max-w-[1600px] mx-auto px-6 w-full">
        ...
        <div class="mb-16 md:w-2/3">
          <h2
            id="benefits-heading"
            class="font-display text-5xl sm:text-7xl text-brand-navy-dark leading-none uppercase mb-6"
          >
            NUESTRO COMPROMISO<br />
            <span class="text-brand-red">CON TU SEGURIDAD</span>
          </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 lg:gap-8">
          ...
          <div class="group md:col-span-2 md:row-span-2 bg-brand-navy-dark rounded-3xl p-8 lg:p-12 shadow-xl hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 relative overflow-hidden flex flex-col justify-between">
            {/* Acento de fondo sutil */}
            <div class="absolute -right-20 -top-20 w-[400px] h-[400px] bg-brand-navy-hover rounded-full blur-3xl opacity-40 group-hover:opacity-80 transition-opacity duration-700 pointer-events-none group-hover:scale-110"></div>
            
            <div class="relative z-10 mb-16">
               <div class="w-16 h-16 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-8 border border-white/10 group-hover:bg-brand-red transition-colors duration-500">
            ...
            <div class="relative z-10 flex flex-wrap gap-10 lg:gap-20">
               <div class="group/metric cursor-default">
                  <div class="font-display text-[5rem] lg:text-[7rem] text-brand-red leading-none mb-2 group-hover/metric:scale-105 group-hover/metric:text-white transition-all duration-300">60</div>
                  <div class="font-heading text-white tracking-widest uppercase text-sm group-hover/metric:text-brand-red transition-colors duration-300">Días de vigencia</div>
               </div>
               <div class="group/metric cursor-default">
                  <div class="font-display text-[5rem] lg:text-[7rem] text-brand-red leading-none mb-2 group-hover/metric:scale-105 group-hover/metric:text-white transition-all duration-300">100<span class="text-5xl lg:text-6xl ml-1 text-brand-red/80 group-hover/metric:text-white/80 transition-colors duration-300">km</span></div>
                  <div class="font-heading text-white tracking-widest uppercase text-sm group-hover/metric:text-brand-red transition-colors duration-300">Distancia de cobertura</div>
               </div>
            </div>
          </div>
